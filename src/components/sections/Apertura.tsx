...
export default function Apertura() {
  return (
    <section id="inicio" className="relative min-h-screen w-full overflow-hidden border-b border-hairline">
      <LazyVideo
      ...
      {/* Ajuste 6: firma más presente, sin navbar tradicional (ese rol ya lo cumple el índice de sistema) */}
      ...
      {/* Ajuste 1 (Cookie desplazado, vía object-position arriba) + Ajuste 2 (texto que respira) */}
